...
Revision ID: e2a86ccfbbe7
Revises:
Create Date: 2025-04-26 11:53:31.393590
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"],
            ["user.id"],
            name=op.f("fk_instructor_id_user"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_instructor")),
        sa.UniqueConstraint("id", name=op.f("uq_instructor_id")),
    )
    op.create_table(
        "vehicle",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"],
            ["user.id"],
            name=op.f("fk_student_id_user"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_student")),
        sa.UniqueConstraint("id", name=op.f("uq_student_id")),
    )
    op.create_table(
        "practice_schedule",
        sa.Column("id", sa.Integer(), nullable=False),
